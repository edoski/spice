"""Same-block-closed feature family."""
...
class SameBlockClosedFeatureFamilyConfig(FeatureFamilyConfig):
    id: str = "same_block_closed"
...
def _log_gas_used(
    ...
    del series, resolved_dependencies
    return helpers.log1p_column(blocks, "gas_used")
...
def _log_gas_limit(
    ...
    del series, resolved_dependencies
    return helpers.log1p_column(blocks, "gas_limit")
...
SAME_BLOCK_CLOSED_FAMILY = FeatureFamily(
