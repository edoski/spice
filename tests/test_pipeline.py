...
from spice_temporal.datasets import lookback_steps_for_seconds
from spice_temporal.pipeline import prepare_dataset, run_training
...
class PipelineTestCase(unittest.TestCase):
    ...
    def test_prepare_dataset(self) -> None:
        ...
        self.assertEqual(prepared.max_extra_wait_steps, 1)
        self.assertEqual(prepared.candidate_block_count, 2)
